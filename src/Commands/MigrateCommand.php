...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'puskesmas-asset:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the PuskesmasAsset project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for PuskesmasAsset project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('puskesmasasset:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
